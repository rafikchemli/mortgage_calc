            ...
            <div className="grid grid-cols-1 md:grid-cols-2 md:gap-12 border-t" style={{ borderColor: 'var(--s-border)' }}>
              ...
              <div className="py-6 md:py-8">
                ...
                <div className="md:hidden">
                  ...
                  <AnimatePresence>
                    {showBreakdown && (
                      <m.div initial={{ opacity: 0, clipPath: 'inset(0 0 100% 0)' }} animate={{ opacity: 1, clipPath: 'inset(0 0 0% 0)' }} exit={{ opacity: 0, clipPath: 'inset(0 0 100% 0)' }} transition={{ duration: 0.25, ease: 'easeOut' }}>
